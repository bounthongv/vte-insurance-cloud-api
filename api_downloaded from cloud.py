...
def upload_invoice():
    ...
    try:
        ...
        taxinv_params = (
            ...
            inv.get("CUST_ACCNO"), inv.get("CUST_ACCNAM"), inv.get("PAY_TYPE"), inv.get("BILL_TYPE"), inv.get("PAY_BANK"), inv.get("AGENCY_FEE"), 
            inv.get("RECEIVED_AMT"), order_no, inv_status, inv.get("ORDER_TYPE"), pay_diff_clear, pay_diff_con
        )
